...
CREATE TABLE `Promocion` (
    ...
    `tipoDescuento` ENUM('MONTO_FIJO', 'PORCENTAJE') NOT NULL DEFAULT 'PORCENTAJE',
    `tipoPromocion` ENUM('POR_PRODUCTO', 'POR_CATEGORIA') NOT NULL DEFAULT 'POR_PRODUCTO',
    `estadoPromo` ENUM('PENDIENTE', 'APLICADA', 'VIGENTE') NOT NULL DEFAULT 'PENDIENTE',
