...
const routes: Routes = [
  ...
  { path: 'pedido-admin',  component: PedidoAdmin, canActivate: [authGuard], data: { roles: ['ADMIN'] },},
  
  { path: 'pedido', component: pedidoIndex, canActivate: [authGuard], data: { roles: ['USER'] }, },

  { path: 'pedido/:id', component: PedidoDetail },

  { path: 'pedido/create', component: PedidoForm, canActivate: [authGuard], data: { roles: ['USER'] }, },
